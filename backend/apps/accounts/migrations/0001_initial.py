    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.CharField(choices=[('food', 'Food'), ('beverage', 'Beverage'), ('fashion', 'Fashion'), ('retail', 'Retail'), ('service', 'Service'), ('others', 'Others')], default='others', max_length=20)),
